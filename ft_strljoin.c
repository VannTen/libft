...
/*   Updated: 2016/12/13 14:55:09 by mgautier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** if that is not the case, ft_strljoin will form a string of up to size
...
char	*ft_strljoin(const char *str_1, const char *str_2, const size_t size)
{
	char	*join;
	size_t	index;
