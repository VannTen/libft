...
#*   Updated: 2017/01/12 20:47:39 by mgautier         ###   ########.fr       *#
#                                                                              #
# **************************************************************************** #
...
SRC := database.c f_add_end_lst.c f_lstiter.c f_strljoin.c f_strsplit_lst.c \
	...
	f_lstmapi.c f_lst_len.c f_lstsearch.c f_lstremoveif_one.c\
	f_fifo_add.c f_fifo_create.c f_fifo_take.c f_fifo_destroy.c f_fifo_extract.c \
	ft_free_string_array.c ft_gen_strdel.c\
	ft_int_square_root.c ft_square_root_round_up.c ft_strnew_char.c
